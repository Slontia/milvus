...
func (c *Core) broadcastCreateRLSPolicy(ctx context.Context, req *rlsutil.CreateRowPolicyRequest, policyID int64) error {
	...
	policy, err := c.meta.PrepareCreateRLSPolicy(ctx, req, policyID)
	if err != nil {
		return err
	}
